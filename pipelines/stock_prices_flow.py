...
def get_tickers() -> list[str]:
    ...
    return (
        pl.from_arrow(universe_arrow)['ticker'].sort().to_list()
    )

@task
def get_stock_prices(tickers: list[str], start: dt.datetime, end: dt.datetime) -> pl.DataFrame:
...
@task
def get_stock_prices_batches(tickers: list[str], start: dt.datetime, end: dt.datetime) -> pl.DataFrame:
